    ...
    sealed class Route(
        ...
        data object AuthScreen : Route(route = "authScreen")
        ...
        data object ReferralNavigation : Route(route = "referralNavigation")
        data object ReferScreen : Route(route = "referScreen")
        data object TrackInviteScreen : Route(route = "trackInviteScreen")
